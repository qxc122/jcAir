...
//#define EMAIN @"QWERTYUIOPASDFGHJKLZXCVBNM.@"
//- (NSString *)ThejudgmentisEMAIN{
//    NSCharacterSet *cs = [[NSCharacterSet characterSetWithCharactersInString:EMAIN] invertedSet];
//    NSString *filtered = [[self componentsSeparatedByCharactersInSet:cs] componentsJoinedByString:@""];
//    return [self isEqualToString:filtered];
//}
//
//
//#define MINGXing @"QWERTYUIOPASDFGHJKLZXCVBNM"
//- (NSString *)ThejudgmentisMINGXing{
//    NSCharacterSet *cs = [[NSCharacterSet characterSetWithCharactersInString:MINGXing] invertedSet];
//    NSString *filtered = [[self componentsSeparatedByCharactersInSet:cs] componentsJoinedByString:@""];
//    return [self isEqualToString:filtered];
//}
