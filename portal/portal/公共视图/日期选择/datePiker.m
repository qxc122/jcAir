...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        if ([[[PortalHelper sharedInstance]get_AppSetPlist].internation isEqualToString:@"0"]) {
            ...
            [myDatePicker setLocale:[[NSLocale alloc]initWithLocaleIdentifier:@"en"]];
        }
        ...
        [change setTitle:NSLocalizedString(@"datePikercancel", @"cancel") forState:UIControlStateNormal];
        ...
        [okok setTitle:NSLocalizedString(@"datePikerDetermine", @"Determine") forState:UIControlStateNormal];
